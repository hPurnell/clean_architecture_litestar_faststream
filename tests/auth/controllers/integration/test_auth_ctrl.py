...
class TestSecuredEndpoint:
    ...
    def test_login_and_access_secured_endpoint(self, fixture_integration_test_client: TestClient, fixture_valid_credentials: dict):
        response = fixture_integration_test_client.post("/auth/login", json=fixture_valid_credentials)
